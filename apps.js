...
const imagenes = [
    {
        name: "Piedra",
        url: "C:\\Users\\samga\\OneDrive\\Documentos\\Codigos\\assets" 
    },
    {
        name: "Papel",
...
function batalla(){
    if(opcionJugador == opcionPc){
        ...
        msjBatalla.innerHTML = "Ganaste Piedra rompe Tijeras!";
    }else if(opcionJugador == "Papel" && opcionPc == "Piedra"){
        msjBatalla.innerHTML = "Ganaste Pape cubre Piedra!";
    }else if(opcionJugador == "Tijeras" && opcionPc == "Papel"){
        msjBatalla.innerHTML = "Ganaste Tijeras cortan Papel!";
    }else{
